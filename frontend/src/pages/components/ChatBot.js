...
function Chatbot() {
  ...
  const [botResponse, setBotResponse] = useState(
    "Hello, I'm Eva! your dedicated AI chatbot for navigating the world of cryptocurrency & finance. How can I be of service to you today?"
  );
            ...
            <div className="flex flex-col h-full">
              <div className="flex flex-col flex-grow">
                <div className="flex flex-col flex-grow px-4 py-6 overflow-y-auto">
                  ...
                  {botResponse && (
                    <div className="flex flex-col mb-4">
                      <span className="text-gray-400 text-sm">Eva</span>
                      <span className="text-white bg-gray-700 rounded-lg px-3 py-2 text-sm mt-2">
                        {botResponse}
                      </span>
                    </div>
